...
int main() {
    ...
    penguin1->addMeetingPlace("Antarctica");
    penguin2->addMeetingPlace("Antarctica");
    penguin3->addMeetingPlace("Antarctica");

    penguin1->removeMeetingPlace("Antarctica");
    penguin2->removeMeetingPlace("Antarctica");
    penguin3->removeMeetingPlace("Antarctica");
