...
int main() {
    ...
    penguin1->addJournalEntry("03/04/2024", "Penguin1 is born.");
    penguin2->addJournalEntry("03/04/2024", "Penguin2 is born.");
    penguin3->addJournalEntry("03/04/2024", "Penguin3 is born.");

    penguin1->modifyJournalEntry("03/04/2024", "Penguin1 is born.");
    // try to modify a non-existing entry
    penguin1->modifyJournalEntry("03/04/2025", "Penguin1 is born.");

    penguin1->removeJournalEntry("03/04/2024");
